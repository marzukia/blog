...
<en-topology title="IOMMU GROUPS" tag="lspci -nns" hint="the gpu and its audio controller share group 29, isolated from the rest of the bus. that's the whole requirement." controls="false" aria-label="IOMMU groups: the GTX 1080 and its audio controller isolated in group 29, other devices in separate groups" legend='[{"swatch":"var(--en-accent)","label":"group 29 — passthrough"},{"swatch":"var(--en-paper3)","label":"other groups"}]' nodes='[{"id":"g29","label":"IOMMU GROUP 29","sub":"isolated — one vm","x":265,"y":96,"w":452,"h":132,"role":"accent","cluster":true,"tip":"<div class=\"en-tip-title\">GROUP 29</div>the only group that matters<br>gpu + its audio controller, nothing else"},{"id":"gpu29","label":"41:00.0","sub":"gtx 1080 · vga","x":170,"y":210,"w":180,"h":72,"role":"accent","tip":"<div class=\"en-tip-title\">NVIDIA GP104 [10de:1b80]</div>VGA compatible controller<br>bound to vfio-pci → the vm"},{"id":"aud29","label":"41:00.1","sub":"hda audio","x":370,"y":210,"w":160,"h":72,"role":"accent","tip":"<div class=\"en-tip-title\">NVIDIA GP104 HDA [10de:10f0]</div>the gpu&#39;s audio controller<br>must be assigned with the gpu"},{"id":"oth","label":"OTHER GROUPS","sub":"every device its own group","x":735,"y":96,"w":452,"h":132,"role":"state","cluster":true,"tip":"<div class=\"en-tip-title\">THE REST OF THE BUS</div>nothing shared with group 29<br>that&#39;s the isolation we needed"},{"id":"d1","label":"42:00.0","sub":"pci device","x":630,"y":210,"w":170,"h":72,"role":"state"},{"id":"d2","label":"44:00.2","sub":"pci device","x":830,"y":210,"w":170,"h":72,"role":"state"},{"id":"host","label":"PCIe HOST","sub":"root complex","x":500,"y":460,"w":320,"h":76,"role":"state","tip":"<div class=\"en-tip-title\">HOST</div>everything hangs off the root complex"}]' edges='[{"from":"host","to":"gpu29","muted":true},{"from":"host","to":"aud29","muted":true},{"from":"host","to":"d1","muted":true},{"from":"host","to":"d2","muted":true}]'></en-topology>
...
<en-topology title="CPU TOPOLOGY" tag="2920x · 12c/24t · lstopo" hint="smt offset +12 — core k is pu k + pu k+12. the vm takes 4 whole cores (c6-c9) on the gpu's numa node. hover a box for the pin map." aria-label="CPU topology: 12 cores across two NUMA nodes. The GTX 1080 sits on NUMA 1, 4.0 hops from cores C6-C9, which the Win10 VM's 8 vCPUs pin to." cycle='["vm","gpu","c6"]' legend='[{"swatch":"var(--en-accent)","label":"vm side — gtx 1080 + 8 pinned vcpu"},{"swatch":"var(--en-blue)","label":"host reserved — emulator + iothreads"},{"swatch":"var(--en-paper3)","label":"free cores · host devices"}]' nodes='[{"id":"numa0","label":"NUMA 0","sub":"6 cores · 12 pu · host side","x":265,"y":96,"w":452,"h":132,"role":"state","cluster":true,"tip":"<div class=\"en-tip-title\">NUMA NODE 0</div>storage + nics hang here<br>0.2 hops to the nics"},{"id":"numa1","label":"NUMA 1","sub":"6 cores · 12 pu · gpu side","x":735,"y":96,"w":452,"h":132,"role":"accent","cluster":true,"tip":"<div class=\"en-tip-title\">NUMA NODE 1</div>pci 41:00.0 (gtx 1080) hangs here<br>4.0 hops to its cores"},{"id":"c0","label":"C0","sub":"pu 0+12","x":85,"y":210,"w":64,"h":72,"role":"blue","tip":"<div class=\"en-tip-title\">CORE 0</div>pu 0 + pu 12<br><b>host:</b> emulator pin 0-1, iothread 1"},{"id":"c1","label":"C1","sub":"pu 1+13","x":157,"y":210,"w":64,"h":72,"role":"blue","tip":"<div class=\"en-tip-title\">CORE 1</div>pu 1 + pu 13<br><b>host:</b> iothread 2 (cpuset 2-3)"},{"id":"c2","label":"C2","sub":"pu 2+14","x":229,"y":210,"w":64,"h":72,"role":"state","tip":"<div class=\"en-tip-title\">CORE 2</div>pu 2 + pu 14<br>free — host use"},{"id":"c3","label":"C3","sub":"pu 3+15","x":301,"y":210,"w":64,"h":72,"role":"state","tip":"<div class=\"en-tip-title\">CORE 3</div>pu 3 + pu 15<br>free — host use"},{"id":"c4","label":"C4","sub":"pu 4+16","x":373,"y":210,"w":64,"h":72,"role":"state","tip":"<div class=\"en-tip-title\">CORE 4</div>pu 4 + pu 16<br>free — host use"},{"id":"c5","label":"C5","sub":"pu 5+17","x":445,"y":210,"w":64,"h":72,"role":"state","tip":"<div class=\"en-tip-title\">CORE 5</div>pu 5 + pu 17<br>free — host use"},{"id":"c6","label":"C6","sub":"pu 6+18","x":555,"y":210,"w":64,"h":72,"role":"accent","tip":"<div class=\"en-tip-title\">CORE 6</div>pu 6 + pu 18<br><b>vm:</b> vcpu 0 → pu 6<br>vcpu 1 → pu 18<br>4.0 hops from the gpu"},{"id":"c7","label":"C7","sub":"pu 7+19","x":627,"y":210,"w":64,"h":72,"role":"accent","tip":"<div class=\"en-tip-title\">CORE 7</div>pu 7 + pu 19<br><b>vm:</b> vcpu 2 → pu 7<br>vcpu 3 → pu 19"},{"id":"c8","label":"C8","sub":"pu 8+20","x":699,"y":210,"w":64,"h":72,"role":"accent","tip":"<div class=\"en-tip-title\">CORE 8</div>pu 8 + pu 20<br><b>vm:</b> vcpu 4 → pu 8<br>vcpu 5 → pu 20"},{"id":"c9","label":"C9","sub":"pu 9+21","x":771,"y":210,"w":64,"h":72,"role":"accent","tip":"<div class=\"en-tip-title\">CORE 9</div>pu 9 + pu 21<br><b>vm:</b> vcpu 6 → pu 9<br>vcpu 7 → pu 21"},{"id":"c10","label":"C10","sub":"pu 10+22","x":843,"y":210,"w":64,"h":72,"role":"state","tip":"<div class=\"en-tip-title\">CORE 10</div>pu 10 + pu 22<br>free — host use"},{"id":"c11","label":"C11","sub":"pu 11+23","x":915,"y":210,"w":64,"h":72,"role":"state","tip":"<div class=\"en-tip-title\">CORE 11</div>pu 11 + pu 23<br>free — host use"},{"id":"nics","label":"NICS","sub":"enp4s0 · wlp5s0 · enp6s0","x":140,"y":380,"w":170,"h":76,"role":"state","tip":"<div class=\"en-tip-title\">HOST NICS</div>enp4s0 · wlp5s0 · enp6s0<br>0.2 hops from numa 0"},{"id":"storage","label":"STORAGE","sub":"3 ssd · 2.5 tb","x":330,"y":380,"w":170,"h":76,"role":"state","tip":"<div class=\"en-tip-title\">HOST STORAGE</div>sda 1863gb · sdb 465gb<br>sdc 238gb = the vm&#39;s raw disk<br>3.9 hops from numa 0"},{"id":"gpu","label":"GTX 1080","sub":"pci 41:00.0 · group 29","x":620,"y":380,"w":200,"h":90,"role":"accent","tip":"<div class=\"en-tip-title\">NVIDIA GP104 [10de:1b80]</div>pci 41:00.0<br>iommu group 29 (with 41:00.1 audio)<br>driver: vfio-pci<br>4.0 hops from cores c6-c9"},{"id":"vm","label":"WIN10 VM","sub":"q35 · uefi · 8 vcpu","x":890,"y":380,"w":150,"h":90,"role":"accent","tip":"<div class=\"en-tip-title\">WIN10 DOMAIN</div>q35 · uefi/ovmf · kvm hidden<br>8 vcpu pinned to cores c6-c9<br>16gb ram"},{"id":"othpci","label":"OTHER PCI","sub":"41:00.1 · 42:00.0 · 44:00.2","x":620,"y":540,"w":200,"h":56,"role":"state","tip":"<div class=\"en-tip-title\">OTHER PCI DEVICES</div>41:00.1 hda audio · 42:00.0 · 44:00.2<br>7.9-16 hops from numa 1"}]' edges='[{"from":"nics","to":"numa0","label":"0.2","d":"M140,342 L121,300 L121,162","labelX":152,"labelY":312},{"from":"storage","to":"numa0","label":"3.9","d":"M330,342 L337,300 L337,162","labelX":352,"labelY":312},{"from":"gpu","to":"c6","muted":true},{"from":"gpu","to":"c7","muted":true},{"from":"gpu","to":"c8","muted":true},{"from":"gpu","to":"c9","label":"4.0"},{"from":"vm","to":"gpu","label":"vfio-pci"},{"from":"othpci","to":"numa1","label":"7.9","d":"M720,540 L810,540 L810,162","labelX":830,"labelY":290}]'></en-topology>
